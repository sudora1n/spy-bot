...
const (
	// а что было под ___2??
	CALLBACK_PREFIX_DELETED_MESSAGE = "___3"
	CALLBACK_PREFIX_DELETED_DETAILS = "___4"
	CALLBACK_PREFIX_DELETED_FILES   = "___5"

	CALLBACK_PREFIX_EDITED_LOG   = "___6"
	CALLBACK_PREFIX_EDITED_FILES = "___7"

	CALLBACK_PREFIX_LANG        = "___8"
	CALLBACK_PREFIX_LANG_CHANGE = "___9"

	CALLBACK_PREFIX_BACK_TO_START    = "__10"
...
const (
	...
	SETTINGS_SHOW_PARTNER_EDITS
	SETTINGS_SHOW_MY_DELETED
	SETTINGS_SHOW_PARTNER_DELETED
)
